...
CREATE TABLE `appointments` (
  ...
  `III` date DEFAULT NULL,
  `IV` date DEFAULT NULL,
  `V` date DEFAULT NULL,
  `VI` date DEFAULT NULL,
  `VII` date DEFAULT NULL,
  `VIII` date DEFAULT NULL,
  `IX` date DEFAULT NULL,
  `X` date DEFAULT NULL,
  `XI` date DEFAULT NULL,
  `XII` date DEFAULT NULL,
  KEY `id` (`id`)
...
-- Dump completed on 2019-07-02 13:23:14
